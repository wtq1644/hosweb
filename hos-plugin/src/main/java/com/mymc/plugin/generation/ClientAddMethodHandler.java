package com.mymc.plugin.generation;
...
public class ClientAddMethodHandler {
    ...
    protected void addInsertBatchMethod(){
        ...
        importedTypes.add(new FullyQualifiedJavaType("com.mymc.mybatis.BaseMapper"));
        ...
        if(!interfaze.getSuperInterfaceTypes().isEmpty()){
            ...
            //加入基础类
            interfaze.getSuperInterfaceTypes().add(new FullyQualifiedJavaType("com.hliedu.mybatis.BaseMapper"));
        }
    }
}
